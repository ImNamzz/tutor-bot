...
export const ClassCard: React.FC<ClassCardProps> = ({
  ...
  return (
    <Link href={`/dashboard/class/${item.id}`} className="group">
      <div className="group relative rounded-xl shadow-sm border border-border/50 overflow-hidden bg-card dark:bg-[#1a1a1a] hover:ring-2 ring-indigo-400 transition">
        {item.bgImage ? (
        ...
        {menuOpen && (
          <div
            className="absolute top-10 right-2 z-10 w-36 rounded-md border bg-card dark:bg-[#1a1a1a] shadow-md"
